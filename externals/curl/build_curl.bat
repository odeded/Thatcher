...
set ROOT_DIR="%CD%"
set RM="%CD%\unxutils\rm.exe"
set CP="%CD%\unxutils\cp.exe"
set MKDIR="%CD%\unxutils\mkdir.exe"
...
rem 
rem echo Compiling dll-release-x64 version...
rem nmake /f Makefile.vc mode=dll VC=%VCVERSION% DEBUG=no GEN_PDB=yes MACHINE=x64
...
rem cd %ROOT_DIR%\builds\libcurl-vc-x86-debug-dll-ipv6-sspi-winssl
rem %MKDIR% -p %ROOT_DIR%\third-party\libcurl\lib\dll-debug-x86
rem %CP% lib\*.pdb %ROOT_DIR%\third-party\libcurl\lib\dll-debug-x86
rem %CP% lib\*.lib %ROOT_DIR%\third-party\libcurl\lib\dll-debug-x86
rem %CP% bin\*.dll %ROOT_DIR%\third-party\libcurl\lib\dll-debug-x86

REM Copy compiled .*lib, *.pdb, *.dll files to third-party\lib\dll-release folder
rem cd %ROOT_DIR%\builds\libcurl-vc-x86-release-dll-ipv6-sspi-winssl
rem %MKDIR% -p %ROOT_DIR%\third-party\libcurl\lib\dll-release-x86
rem %CP% lib\*.pdb %ROOT_DIR%\third-party\libcurl\lib\dll-release-x86
rem %CP% lib\*.lib %ROOT_DIR%\third-party\libcurl\lib\dll-release-x86
rem %CP% bin\*.dll %ROOT_DIR%\third-party\libcurl\lib\dll-release-x86

REM Copy compiled .*lib file in lib-release folder to third-party\lib\static-debug folder
cd %ROOT_DIR%\builds\libcurl-vc-x86-debug-static-ipv6-sspi-winssl
...
cd %ROOT_DIR%\builds\libcurl-vc-x86-release-static-ipv6-sspi-winssl
%MKDIR% -p %ROOT_DIR%\third-party\libcurl\lib\static-release-x86
%CP% lib\*.lib %ROOT_DIR%\third-party\libcurl\lib\static-release-x86

REM Copy compiled .*lib, *.pdb, *.dll files folder to third-party\lib\dll-debug folder
rem cd %ROOT_DIR%\builds\libcurl-vc-x64-debug-dll-ipv6-sspi-winssl
rem %MKDIR% -p %ROOT_DIR%\third-party\libcurl\lib\dll-debug-x64
rem %CP% lib\*.pdb %ROOT_DIR%\third-party\libcurl\lib\dll-debug-x64
rem %CP% lib\*.lib %ROOT_DIR%\third-party\libcurl\lib\dll-debug-x64
rem %CP% bin\*.dll %ROOT_DIR%\third-party\libcurl\lib\dll-debug-x64

REM Copy compiled .*lib, *.pdb, *.dll files to third-party\lib\dll-release folder
rem cd %ROOT_DIR%\builds\libcurl-vc-x64-release-dll-ipv6-sspi-winssl
rem %MKDIR% -p %ROOT_DIR%\third-party\libcurl\lib\dll-release-x64
rem %CP% lib\*.pdb %ROOT_DIR%\third-party\libcurl\lib\dll-release-x64
rem %CP% lib\*.lib %ROOT_DIR%\third-party\libcurl\lib\dll-release-x64
rem %CP% bin\*.dll %ROOT_DIR%\third-party\libcurl\lib\dll-release-x64

REM Copy compiled .*lib file in lib-release folder to third-party\lib\static-debug folder
cd %ROOT_DIR%\builds\libcurl-vc-x64-debug-static-ipv6-sspi-winssl
%MKDIR% -p %ROOT_DIR%\third-party\libcurl\lib\static-debug-x64
%CP% lib\*.lib %ROOT_DIR%\third-party\libcurl\lib\static-debug-x64

REM Copy compiled .*lib files in lib-release folder to third-party\lib\static-release folder
cd %ROOT_DIR%\builds\libcurl-vc-x64-release-static-ipv6-sspi-winssl
